...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="assets/chatomz.png" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Dunia Hewan</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Daftar Hewan</a></li>
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Daftar Hewan</h2>
                <!-- Icon Divider-->
                                            ...
                                            <div class="container">
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-12 col-md-12 text-center">
                                                        <h2 class="portfolio-modal-title text-secondary text-uppercase mb-2"><?=$item->nama?></h2>
                                                        <div class="divider-custom">
                                                            <div class="divider-custom-line"></div>
                                                            <!-- <div class="divider-custom-icon"><i class="fas fa-star"></i></div> -->
                                                    ...
                                                    <div class="col-lg-6 col-md-6 text-center">
                                                        ...
                                                        <img class="img-fluid rounded mb-5" src="https://chatomz.bunefit.com/public/img/company/informasi/hewan/<?=$item->gambar?>" alt="..." />
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Kontak Saya</h2>
                <!-- Icon Divider-->
                <div class="divider-custom">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
